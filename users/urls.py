...
from .views import UserRegisterView, UserProfileView, BuyCryptoView, SellCryptoView, TradeHistoryView, UserNetWorthView, GlobalLeaderboardView, CustomTokenObtainPairView
